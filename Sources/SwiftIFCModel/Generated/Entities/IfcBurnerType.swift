...
extension IFC4X3 {
    public class IfcBurnerType: IfcEnergyConversionDeviceType, @unchecked Sendable {
        public var predefinedType: IfcBurnerTypeEnum? = nil
        ...
        public init(
            ...
            predefinedType: IfcBurnerTypeEnum? = nil
        ) {
