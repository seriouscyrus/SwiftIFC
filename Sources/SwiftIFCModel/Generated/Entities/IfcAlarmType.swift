...
extension IFC4X3 {
    public class IfcAlarmType: IfcDistributionControlElementType, @unchecked Sendable {
        public var predefinedType: IfcAlarmTypeEnum? = nil
        ...
        public init(
            ...
            predefinedType: IfcAlarmTypeEnum? = nil
        ) {
