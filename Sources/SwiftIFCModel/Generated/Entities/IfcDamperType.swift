...
extension IFC4X3 {
    public class IfcDamperType: IfcFlowControllerType, @unchecked Sendable {
        public var predefinedType: IfcDamperTypeEnum? = nil
        ...
        public init(
            ...
            predefinedType: IfcDamperTypeEnum? = nil
        ) {
