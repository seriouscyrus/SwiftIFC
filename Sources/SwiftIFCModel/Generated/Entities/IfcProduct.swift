...
extension IFC4X3 {
    public class IfcProduct: IfcObject, @unchecked Sendable { // ABSTRACT
        public var objectPlacement: IfcObjectPlacement? = nil
        public var representation: IfcProductRepresentation? = nil
