...
extension IFC4X3 {
    public class IfcSpace: IfcSpatialStructureElement, @unchecked Sendable {
        public var predefinedType: IfcSpaceTypeEnum? = nil
        public var elevationWithFlooring: IfcLengthMeasure? = nil
        ...
        public init(
            ...
            elevationWithFlooring: IfcLengthMeasure? = nil
        ) {
