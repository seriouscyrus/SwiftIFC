...
extension IFC4X3 {
    public class IfcEngineType: IfcEnergyConversionDeviceType, @unchecked Sendable {
        public var predefinedType: IfcEngineTypeEnum? = nil
        ...
        public init(
            ...
            predefinedType: IfcEngineTypeEnum? = nil
        ) {
