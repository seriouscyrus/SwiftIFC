...
extension IFC4X3 {
    public class IfcMarinePart: IfcFacilityPart, @unchecked Sendable {
        public var predefinedType: IfcMarinePartTypeEnum? = nil
        ...
        public init(
            ...
            predefinedType: IfcMarinePartTypeEnum? = nil
        ) {
