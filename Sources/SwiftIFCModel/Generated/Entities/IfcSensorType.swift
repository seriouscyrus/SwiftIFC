...
extension IFC4X3 {
    public class IfcSensorType: IfcDistributionControlElementType, @unchecked Sendable {
        public var predefinedType: IfcSensorTypeEnum? = nil
        ...
        public init(
            ...
            predefinedType: IfcSensorTypeEnum? = nil
        ) {
