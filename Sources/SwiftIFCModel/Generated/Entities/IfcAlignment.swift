...
extension IFC4X3 {
    public class IfcAlignment: IfcLinearPositioningElement, @unchecked Sendable {
        public var predefinedType: IfcAlignmentTypeEnum? = nil
        ...
        public init(
            ...
            predefinedType: IfcAlignmentTypeEnum? = nil
        ) {
