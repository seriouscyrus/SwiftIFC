...
extension IFC4X3 {
    public class IfcBridgePart: IfcFacilityPart, @unchecked Sendable {
        public var predefinedType: IfcBridgePartTypeEnum? = nil
        ...
        public init(
            ...
            predefinedType: IfcBridgePartTypeEnum? = nil
        ) {
