...
extension IFC4X3 {
    public class IfcCoilType: IfcEnergyConversionDeviceType, @unchecked Sendable {
        public var predefinedType: IfcCoilTypeEnum? = nil
        ...
        public init(
            ...
            predefinedType: IfcCoilTypeEnum? = nil
        ) {
