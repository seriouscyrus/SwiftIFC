...
extension IFC4X3 {
    public class IfcReferent: IfcPositioningElement, @unchecked Sendable {
        public var predefinedType: IfcReferentTypeEnum? = nil
        ...
        public init(
            ...
            predefinedType: IfcReferentTypeEnum? = nil
        ) {
