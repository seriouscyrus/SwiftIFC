...
extension IFC4X3 {
    public class IfcActuator: IfcDistributionControlElement, @unchecked Sendable {
        public var predefinedType: IfcActuatorTypeEnum? = nil
        ...
        public init(
            ...
            predefinedType: IfcActuatorTypeEnum? = nil
        ) {
