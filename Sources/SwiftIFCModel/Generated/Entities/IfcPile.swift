...
extension IFC4X3 {
    public class IfcPile: IfcDeepFoundation, @unchecked Sendable {
        public var predefinedType: IfcPileTypeEnum? = nil
        public var constructionType: IfcPileConstructionEnum? = nil
